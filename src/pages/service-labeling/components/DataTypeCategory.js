      ...
      <div className={styles.CategoryInnerWrap}>
        ...
        <ul className={styles.CategoryList}>
          <li className={styles.CategoryItem}>
            <a href="/gendata-service-labeling"><img src={IconImg} alt="데이터타입 이미지 아이콘" /><span className={styles.Active}>이미지</span></a>
          </li>
          <li className={styles.CategoryItem}>
            <a href="/data-process-3d"><img src={Icon3D} alt="데이터타입 3d 아이콘" /><span>3D 데이터</span></a>
          </li>
          <li className={styles.CategoryItem}>
