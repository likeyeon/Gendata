      ...
      <div>
        ...
        <div className="gridContainer">
          <div className="gridItems">
            <img className="gridItemsImge" src={thumbsUp} alt="Thumbs Up" />
            <h4 className="gridItemsTitle">데이터 품질</h4>
            <p className="gridItemscontents">
              내부 품질 프로세스를 통해 고품질 데이터를 <br />
              구축합니다.
            </p>
          </div>
          <div className="gridItems">
            <img className="gridItemsImge" src={tools} alt="Tools" />
            <h4 className="gridItemsTitle">Annotation Tools</h4>
            <p className="gridItemscontents">
              다양한 라벨링 툴을 제공합니다.
              <br />
          ...
          <div className="gridItems">
            <img className="gridItemsImge" src={lock} alt="Lock and Key" />
            <h4 className="gridItemsTitle">데이터 보안</h4>
            <p className="gridItemscontents">
          ...
          <div className="gridItems">
            <img className="gridItemsImge" src={monkey} alt="monkey" />
            <h4 className="gridItemsTitle">개인정보 이슈차단</h4>
            <p className="gridItemscontents">
          ...
          <div className="gridItems">
            <img className="gridItemsImge" src={cd} alt="cd" />
            <h4 className="gridItemsTitle">A-Z 데이터 구축 서비스</h4>
            <p className="gridItemscontents">
