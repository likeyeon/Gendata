...
const Header = () => (
  <section className={styles.section}>
    <div className={styles.container}>
      <a className={styles.item} href="https://blog.naver.com/ai-gendata/223189350612">
      ...
      <a className={styles.item} href="https://blog.naver.com/ai-gendata/223193243761">
      ...
      <a className={styles.item} href="https://docs.google.com/forms/d/e/1FAIpQLSc0uiViLIF9SHuxV6-7JG2i2-2gtlqWqqjRM8Vyw16g94nmkA/viewform?fbzx=1812570764583944529">
